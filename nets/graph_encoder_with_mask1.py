...
class EncoderLayer(nn.Module):
    ...
    def forward(self, input1, mask):
        ...
        out_concat = multi_head_attention(q, k, v, mask)
...
def multi_head_attention(q, k, v, mask=None, rank2_ninf_mask=None, rank3_ninf_mask=None):
    ...
    if mask is not None:
        score_scaled[mask[:, None, None, :].expand(batch_s, head_num, n, input_s)] = -math.inf
