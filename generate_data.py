...
def generate_vrp_data(dataset_size, vrp_size, depot_size):
    CAPACITIES = {
        10: 20.,
        20: 30.,
        50: 40.,
    ...
    return list(zip(
        np.random.uniform(size=(dataset_size, depot_size, 2)).tolist(),  # Depot location
...
if __name__ == "__main__":
    ...
    parser.add_argument('--depot_size', type=int, default=2, help="The size of the depot")
            ...
            for graph_size in opts.graph_sizes:
                ...
                if opts.filename is None:
                    filename = os.path.join(datadir, "{}{}{}_{}{}_seed{}.pkl".format(
                        ...
                        graph_size, opts.name, opts.depot_size, opts.seed))
                else:
                ...
                if problem == 'tsp':
                    ...
                    dataset = generate_vrp_data(
                        opts.dataset_size, graph_size,opts.depot_size)
                elif problem == 'pctsp':
