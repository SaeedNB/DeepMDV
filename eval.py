...
def eval_dataset(dataset_path, width, softmax_temp, opts):
    ...
    if opts.multiprocessing:
        ...
        dataset = model.problem.make_dataset(filename=dataset_path, depot_size=opts.depot_size, num_samples=opts.val_size, offset=opts.offset)
...
def _eval_dataset(model, dataset, width, softmax_temp, opts, device):
    ...
    model.set_decode_type(
        ...
        temp=softmax_temp)
    model.set_k_value(opts.k)
    model.set_tsp_solver(opts.tsp_solver)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--depot_size', type=int, default=4, help="The size of the depot")
